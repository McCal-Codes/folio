...
| 5 | ~~TalkBack labels for the editor~~ (done: every jiggle-mode pill has one; Today View's "Add widget" was hard-coded English and is a string now; the page dots have one per slice since #144) | S |
