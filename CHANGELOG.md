...
- **The background moves with your pages.** Folio's dunes or your own photo now drift a little as you swipe between Home pages, the way Android's wallpaper already did. Settings > Wallpaper & Appearance > Background moves with pages is one switch for both now, instead of appearing only when Android's wallpaper was behind Home. It's a slide and nothing more, so a swipe costs the same as it did, and Reduce Motion keeps it still.
