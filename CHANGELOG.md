...
### Changed
- **Release notes you can read:** What's New draws a release's notes properly now, so a line can stress the word that matters, put a name in italics, or link to the page that explains it, instead of showing the markers around them.
